...
<!-- {{% callout note %}}
This post was originally published on [Lunatech's blog]()
{{% /callout %}} -->
...
![Chain of verifiability](./images/diagram2.png)
...
<details>
<summary>Details of Alice's and Bob's encrypted ballots</summary>
...
<details>
<summary>Result of `+sbt run+`</summary>
